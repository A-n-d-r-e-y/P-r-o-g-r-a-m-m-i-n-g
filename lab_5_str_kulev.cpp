...
setlocale(LC_ALL, "rus");
	...
	cout << "В текстовом файле хранится информация о цветах, находящихся на цветочном складе." << endl <<
			"Для каждого вида цветов известно : "<< endl <<
			" - количество имеющихся цветов;" << endl <<
			" - название цветов;" << endl <<
			" - срок годности; " << endl <<
			" - стоимость одного цветка в рублях." << endl <<
			"Количество разных видов цветов на складе неизвестно.\n" << endl;
